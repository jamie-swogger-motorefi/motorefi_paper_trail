...
module MotorefiPaperTrail
  module Serializers
    # The default serializer for, e.g. `motorefi_versions.object`.
    module YAML
      ...
      # recent [memory optimizations](https://github.com/motorefi-paper-trail-gem/motorefi_paper_trail/pull/1189),
