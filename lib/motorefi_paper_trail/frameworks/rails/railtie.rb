...
module MotorefiPaperTrail
  ...
  class Railtie < ::Rails::Railtie
    # MotorefiPaperTrail only has one initializer.
    #
    ...
    initializer "motorefi_paper_trail", before: "load_config_initializers" do
