...
module MotorefiPaperTrail
  module Queries
    module Versions
      ...
      # `motorefi_paper_trail/version_concern.rb`.
      # @api private
      class WhereObjectChangesFrom
        ...
        # @api private
        def execute
          if MotorefiPaperTrail.config.object_changes_adapter.respond_to?(:where_object_changes_from)
            return MotorefiPaperTrail.config.object_changes_adapter.where_object_changes_from(
