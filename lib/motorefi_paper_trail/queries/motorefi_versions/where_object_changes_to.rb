  ...
  module Queries
    module Versions
      ...
      class WhereObjectChangesTo
        ...
        # @api private
        def execute
          if MotorefiPaperTrail.config.object_changes_adapter.respond_to?(:where_object_changes_to)
            return MotorefiPaperTrail.config.object_changes_adapter.where_object_changes_to(
