  ...
  module Queries
    module Versions
      ...
      class WhereObjectChanges
        ...
        # @api private
        def execute
          if MotorefiPaperTrail.config.object_changes_adapter.respond_to?(:where_object_changes)
            return MotorefiPaperTrail.config.object_changes_adapter.where_object_changes(
