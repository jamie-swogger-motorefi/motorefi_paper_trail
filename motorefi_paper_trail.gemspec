...
Gem::Specification.new do |s|
  s.name = "motorefi_paper_trail"
  s.version = MotorefiPaperTrail::VERSION::STRING
...
has been destroyed.
  EOS
  s.homepage = "https://github.com/motorefi-paper-trail-gem/motorefi_paper_trail"
  ...
  # https://github.com/motorefi-paper-trail-gem/motorefi_paper_trail/pull/1279#pullrequestreview-558840513
  ...
  # PT supports ruby motorefi_versions until they reach End-of-Life, historically
  ...
  s.add_dependency "activerecord", ::MotorefiPaperTrail::Compatibility::ACTIVERECORD_GTE

  # PT supports request_store motorefi_versions for 3 years.
  ...
  s.add_development_dependency "rails", ::MotorefiPaperTrail::Compatibility::ACTIVERECORD_GTE
  ...
  # assuming said call is consistent for all motorefi_versions of rails we test against
  # (see `Appraisals`).
  #
  # Currently, all motorefi_versions of rails we test against are consistent. In the past,
