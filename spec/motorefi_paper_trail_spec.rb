...
RSpec.describe MotorefiPaperTrail do
  describe ".request" do
  ...
  describe ".gem_version" do
    it "returns a Gem::Version" do
      ...
      expect(v.to_s).to eq(::MotorefiPaperTrail::VERSION::STRING)
    end
  end
  ...
  context "when default" do
    ...
    context "when error within `with_versioning` block" do
      it "reverts the value of `MotorefiPaperTrail.enabled?` to its previous state" do
        expect(described_class).not_to be_enabled
