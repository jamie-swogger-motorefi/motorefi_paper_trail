...
RSpec.describe Translation, type: :model, versioning: true do
  ...
  context "with US translations" do
    context "with drafts" do
      it "creation does not change the number of motorefi_versions" do
      ...
      it "update does not change the number of motorefi_versions" do
        translation = described_class.new(headline: "Headline")
        translation.language_code = "US"
        translation.draft_status = "DRAFT"
        translation.save!
      ...
      it "touch does not change the number of motorefi_versions" do
        translation = described_class.new(headline: "Headline")
        translation.language_code = "US"
        translation.draft_status = "DRAFT"
        translation.save!
    ...
    context "with non-drafts" do
      ...
      it "destroy changes the number of motorefi_versions" do
        translation = described_class.new(headline: "Headline")
        translation.language_code = "US"
        translation.save!
        translation.destroy
