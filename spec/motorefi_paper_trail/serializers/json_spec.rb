    ...
    ::RSpec.describe JSON do
      ...
      describe ".where_object_condition" do
        context "when value is a string" do
          it "construct correct WHERE query" do
            matches = described_class.
              where_object_condition(MotorefiPaperTrail::Version.arel_table[:object], :arg1, "Val 1")
        ...
        context "when value is null" do
          it "construct correct WHERE query" do
            matches = described_class.
              where_object_condition(MotorefiPaperTrail::Version.arel_table[:object], :arg1, nil)
            expect(matches.instance_of?(Arel::Nodes::Matches)).to(eq(true))
        ...
        context "when value is a number" do
          it "construct correct WHERE query" do
            grouping = described_class.
              where_object_condition(MotorefiPaperTrail::Version.arel_table[:object], :arg1, -3.5)
